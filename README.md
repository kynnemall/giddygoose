...
1. A simulator to estimate the probability that N random women will be on their period at the same time - [honk](https://giddygoose.streamlit.app/Period_Probability)
2. An ML app to classify baked goods as either biscuit, cake, bread, or pastry - [honk](https://giddygoose.streamlit.app/Baking_Classifier)
